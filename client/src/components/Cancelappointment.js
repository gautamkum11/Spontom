        ...
        <>
            ...
            <div className = "actionbox1" style = {{height: "30rem",width: "35rem"}}> 
                <div className = "actionbox2">
                    <p className = "viewfont">Cancel Appointment</p>
                ...
                <div className = "actionbox4" style={{flexDirection: "column"}}>
                    ...
                    <RadioGroup
                        ...
                        style = {{display: "flex",flexDirection:"column",margin:"1rem 0 1rem 0"}}
                    >
                        <FormControlLabel value="morning" control={<Radio />} label="I'm not available on schedule" />
                        <FormControlLabel value="afternoon" control={<Radio />} label="I have a activity that can't be left behind" />
                        <FormControlLabel value="evening" control={<Radio />} label="Others" />
                    </RadioGroup>
                    </FormControl>
                    <textarea style = {{margin:"0 0 1rem 0", borderRadius: "5px",padding: "10px"}} placeholder= "Type Reason" rows="3" cols="60"></textarea>
                </div>
